			...
			{#each links as link, i (link.href)}
				<li>
					<a
						...
						class={cn(
							'font-sans font-medium text-muted transition-colors duration-150 ease-out hover:text-accent focus-visible:rounded-xs focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent',
