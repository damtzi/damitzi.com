<script lang="ts">
	...
	import { TypographyH1, TypographyH2, TypographyH3, TypographyP } from '$lib/components/typography';
	...
	const education: CvEntry[] = [
		{
			...
			items: [
				'Advanced programming: OOP, recursion, functional programming.',
				'Operating systems: file systems, semaphores, concurrency, race conditions.',
				'Software design: object-oriented design, use cases, statecharts.',
				'Human-computer interaction and UX design principles.',
				'Internet applications engineering: responsive web design and web development.'
			]
		}
	];
	...
	const workExperience: CvEntry[] = [
		...
		{
			title: 'Secretarium',
			meta: 'Sep 2020-Nov 2025 / London, UK + Remote',
			description: 'Frontend engineer',
			items: [
		...
		{
			title: 'IT Partnering & Innovation at Lancaster University',
			meta: 'Jan 2020-Jul 2020 / Lancaster, UK',
			description: 'Frontend engineer',
			items: [
...
<div class="flex flex-col gap-8">
	<div class="flex flex-col gap-2">
		...
		<TypographyP>
			I am a product engineer based in Gdynia with deep React, Next.js, and TypeScript
			experience across travel, subscriptions, privacy tech, and AI products. I've led frontend
			work from early product shaping through production delivery, including booking funnels,
			paywalls, developer tools, CMS platforms, and mobile experiences. I care about clear UX,
			reliable systems, and shipping work that moves the product.
		</TypographyP>
	</div>
	...
	<section class="flex flex-col gap-5">
		...
		{#each workExperience as entry}
			<article class="flex flex-col gap-2 border-l border-gray-200 pl-4 dark:border-gray-700">
				<div class="flex flex-col gap-1 sm:flex-row sm:items-baseline sm:justify-between">
					<TypographyH3>{entry.title}</TypographyH3>
					<p class="font-mono text-sm text-gray-500">{entry.meta}</p>
				</div>
				...
				<ul class="list-disc space-y-1 pl-5 text-gray-700 dark:text-gray-300">
